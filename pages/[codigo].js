...
import { clearBusqueda, saveIdComercio } from '../components/Inicialized/Actions';
...
const Index = ({ slides, empresas, municipios, tipo, saveIdComercio, codigo }) => {
        ...
        if (tipo.length != 0) {
            ...
            switch (tipo[0].tipo) {
                ...
                case -1:
                    //set variable 
                    saveIdComercio(codigo);
                    return <PerfilCero inactivo={true} />
                    break;
